...
public  class FileModule
{
    ...
    /// <returns></returns>
    public static Dictionary<string, List<string>> RemoveTempFile(Dictionary<string, List<string>> allFilePaths,string TempFileFileNameStartString = ExcelTableSetting.ExcelTempFileFileNameStartString)
    {
    ...
    /// 获取导出某种生成文件的存储目录
    /// </summary>
    public static string GetExportDirectoryPath(string tableName, string exportRootPath,bool IsExportKeepDirectoryStructure)
    {

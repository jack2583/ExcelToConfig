...
public partial class TableCheckHelper
{
    ...
    /// refStr:table[entry_dungeon_event.event_id](split{1;|;,}(;))(except{0})
    /// 如：1001,50000|2001,5556|2002,5556|2003,5556|3001,5556|3002,5556|3003,5556|4001,16667
    /// </summary>
                    ...
                    if (temp.StartsWith(START_STRING2, StringComparison.CurrentCultureIgnoreCase))//如果是以 refStr:table开头则
                    {
                        ...
                        if (unreferencedInfo.Count > 0)
                        {
                            ...
                            foreach (var item in unreferencedInfo)
                            {
                                ...
                                int irow = int.Parse(item2[0]) + ExcelTableSetting.DataFieldDataStartRowIndex + 1;
